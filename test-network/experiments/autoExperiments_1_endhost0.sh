...
do
  ...
  do
    ...
    run_cmd_on_device 5 "cd mainPlan/fabricWithEbpfSequencer/sequencer && export GO111MODULE=on && go mod tidy && nohup go run . 4 > text.log 2>&1 &"
    ...
    run_cmd_on_device 2 "cd mainPlan/fabricWithEbpfSequencerExperiment/test-network/experiments/ex2/server && export GO111MODULE=on && go mod tidy && nohup go run . > endhost_rps_'$((500*t))'_pkgsize_'$((1500*i))'_no_'$s'.log 2>&1 &"
    run_cmd_on_device 2 "cd mainPlan/fabricWithEbpfSequencerExperiment/test-network/experiments/ex2/client && export GO111MODULE=on && go mod tidy && nohup go run . $((500*t)) $((1500*i)) > text.log 2>&1 &"
    run_cmd_on_device 5 "cd mainPlan/fabricWithEbpfSequencerExperiment/test-network/experiments && nohup ./udpDropDetect.sh endhost_DROP_rps_'$((500*t))'_pkgsize_'$((1500*i))'_no_'$s'.log > text.log 2>&1 &"
